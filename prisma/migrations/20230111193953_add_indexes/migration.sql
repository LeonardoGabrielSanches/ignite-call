-- DropForeignKey
ALTER TABLE `UserTimeIntervals` DROP FOREIGN KEY `UserTimeIntervals_user_id_fkey`;
...
-- RenameIndex
ALTER TABLE `UserTimeIntervals` RENAME INDEX `UserTimeIntervals_user_id_fkey` TO `UserTimeIntervals_user_id_idx`;
